window.skins={};
                ...
                window.generateEUI = {};
                generateEUI.paths = {};
                generateEUI.styles = {"1":{"textColor":"0x6e442a","textAlign":"center","size":"22"},"white":{"textColor":"0xffffff"},"red":{"textColor":"0xFF0B0B"},"green":{"textColor":"0x25e31c"},"yellow":{"textColor":"0xffe045"}};
	...
	function GameOverViewSkin() {
		_super.call(this);
		this.skinParts = ["lb_sore","lb_best_today","lb_best_all_time","lb_best_today_num","lb_today_new","lb_best_all_time_num","lb_all_time_new","img_title","btn_submit"];
	...
	_proto._Group3_i = function () {
		...
		t.horizontalCenter = 0;
		t.verticalCenter = 0;
		t.elementsContent = [this._Image1_i(),this._Image2_i(),this.lb_sore_i(),this.lb_best_today_i(),this.lb_best_all_time_i(),this._Group1_i(),this._Group2_i(),this._Label1_i(),this.img_title_i(),this.btn_submit_i()];
		return t;
	};
	...
	_proto._Image5_i = function () {
		var t = new eui.Image();
		t.percentHeight = 100;
		t.scale9Grid = new egret.Rectangle(228,502,2,2);
	...
	_proto.gp_game_over_i = function () {
		var t = new eui.Group();
		this.gp_game_over = t;
		t.percentHeight = 100;
		t.horizontalCenter = 0;
		...
		t.visible = false;
		t.percentWidth = 100;
		t.elementsContent = [this.img_game_over_tip_i()];
		return t;
	};
	_proto.img_game_over_tip_i = function () {
		var t = new eui.Image();
		this.img_game_over_tip = t;
		t.horizontalCenter = 0;
		t.scaleX = 0.8;
		t.scaleY = 0.8;
		t.source = "gameTexture_json.text_Time_up_white";
		t.verticalCenter = 0;
		return t;
	};
	return GameViewSkin;
	...
	_proto._Label1_i = function () {
		...
		t.lineSpacing = 10;
		t.size = 43;
		t.text = "Let's learn how to play\nbefore starting the match.";
		t.textAlign = "center";
		t.verticalCenter = 20;
		return t;
	};
